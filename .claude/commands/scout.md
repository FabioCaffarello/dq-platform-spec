...
3. Scan **breadth-first**. Open, in order: the root listing, root
...
4. Fill `templates/scout.md` into
...
5. For every Entry-point row, lead with *why it matters first* — not
   what is in it. Three to seven entries is healthy.
6. Write the self-critique honestly — including what you did NOT
